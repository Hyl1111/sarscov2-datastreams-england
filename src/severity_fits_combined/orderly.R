orderly2::orderly_parameters(short_run = TRUE, deterministic = TRUE, data_changed = "original")
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "london" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "east_of_england" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "midlands" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "north_east_and_yorkshire" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "north_west" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "south_east" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
...
orderly2::orderly_dependency(
  "severity_fits",
  'latest(parameter:region == "south_west" && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic)',
